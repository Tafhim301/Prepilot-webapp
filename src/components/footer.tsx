  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -top-32 -right-32 w-[520px] h-[520px] rounded-full bg-linear-to-bl from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-14 blur-[130px]" />
        {/* Primary gradient — bottom-left */}
        <div className="absolute -bottom-20 -left-20 w-[440px] h-[440px] rounded-full bg-linear-to-tr from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-11 blur-[110px]" />
        {/* Center sweep */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[260px] rounded-full bg-linear-to-r from-[#6a00ff] to-[#a100ff] opacity-6 blur-[120px]" />
      </div>
