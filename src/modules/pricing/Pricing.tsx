        ...
        <AnimatePresence>
          {!annual && (
            <motion.span
              ...
              style={{ background: "rgba(160,48,200,0.25)", color: "#d090f0" }}
            >
              −{discount}%
            </motion.span>
          )}
...
function PlanCard({ plan, annual, index }: { plan: PricingPlan; annual: boolean; index: number }) {
  ...
  return (
    <motion.div
      ...
      style={
        H
          ? { ...cardGlassElevated, boxShadow: `0 32px 64px -16px rgba(0,0,0,0.6), 0 0 0 1px rgba(160,48,200,0.35), 0 8px 24px -8px ${P.pink}40` }
          : { ...cardGlass }
      }
      onMouseEnter={(e) => {
    ...
    >
        ...
        <div
          ...
          style={
            H
              ...
              : { background: "rgba(160,48,200,0.15)", color: "#d090f0", border: "1px solid rgba(160,48,200,0.28)" }
          }
        >
      ...
      <div className="px-8 pt-8 pb-6 relative z-10">
        ...
        <p className="text-sm mt-5 leading-relaxed" style={{ color: P.inkMid }}>
          {plan.tagline}
        </p>
      </div>
        ...
        {plan.features.map((f) => (
          <div key={f.label} className="flex items-start gap-3">
            <div
              ...
              style={
                f.included
                  ? { background: H ? GRAD : "rgba(160,48,200,0.2)" }
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: open ? "1px solid rgba(160,48,200,0.28)" : cardGlass.border,
      }}
    >
      <button
    ...
    >
      ...
      <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ background: `radial-gradient(ellipse, ${P.violet}, transparent 70%)` }}
        />
        <div
          className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full blur-[110px] opacity-14"
        ...
        <div
          ...
          style={{ background: `radial-gradient(circle, ${P.purple}, transparent 65%)` }}
        />
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          style={{ ...cardDark, boxShadow: `0 24px 60px -12px rgba(0,0,0,0.5), 0 0 0 1px rgba(160,48,200,0.2)` }}
        >
          <div
            aria-hidden
            className="absolute inset-0 pointer-events-none"
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="mt-3 text-base leading-relaxed max-w-sm" style={{ color: P.inkMid }}>
