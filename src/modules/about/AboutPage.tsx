...
import {
  P, GRAD, GRAD_TEXT, GRAD_SECTION, GRAD_SECTION_ALT, GRAD_SECTION_ABOUT,
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[-10%] right-[-5%] w-[720px] h-[720px] rounded-full bg-linear-to-bl from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-20 blur-[130px]" />
        {/* Primary gradient — bottom-left */}
        <div className="absolute bottom-[-15%] left-[-8%] w-[580px] h-[580px] rounded-full bg-linear-to-tr from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-14 blur-[120px]" />
        {/* Center sweep */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[380px] rounded-full bg-linear-to-r from-[#6a00ff] to-[#a100ff] opacity-7 blur-[150px]" />
      </motion.div>
      ...
      >
        <div className="max-w-4xl">
          ...
          <motion.p
            ...
            className="mt-8 text-xl md:text-2xl leading-relaxed max-w-2xl"
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-10 relative overflow-hidden" style={{ background: P.darkBg }}>
      ...
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div
          className="absolute -top-32 -right-32 w-[700px] h-[700px] rounded-full blur-[130px] opacity-16"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          <FadeIn direction="left">
            ...
            <div className="space-y-5 text-lg leading-relaxed" style={{ color: P.onDarkMid }}>
              <p>
...
function Values() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-10" style={{ background: GRAD_SECTION_ABOUT }}>
      <div className="max-w-7xl mx-auto">
        <FadeIn className="text-center mb-16">
          ...
          <p className="mt-5 text-xl max-w-xl mx-auto leading-relaxed" style={{ color: P.inkMid }}>
            ...
            <FadeIn key={v.title} delay={i * 0.07}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base leading-relaxed" style={{ color: P.inkMid }}>{v.body}</p>
                </div>
              </motion.div>
            </FadeIn>
          ))}
                  ...
                  >
                    <div className={`flex-1 pl-12 lg:pl-0 ${isRight ? "lg:text-right lg:pr-12" : "lg:text-left lg:pl-12"}`}>
                      ...
                      >
                        ...
                        <p className="text-base leading-relaxed" style={{ color: P.inkMid }}>{item.body}</p>
                      </motion.div>
                    </div>
    ...
    <section className="py-24 px-4 sm:px-6 lg:px-10 relative overflow-hidden" style={{ background: P.darkBg }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <FadeIn className="text-center mb-16">
          ...
          <p className="mt-5 text-xl max-w-xl mx-auto leading-relaxed" style={{ color: P.onDarkMid }}>
          ...
          {TEAM.map((member, i) => (
            <FadeIn key={member.name} delay={i * 0.07}>
              ...
              >
                ...
                <p className="text-base leading-relaxed" style={{ color: P.onDarkMid }}>{member.bio}</p>
              </motion.div>
            </FadeIn>
          ))}
        </div>
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  ...
                  <span
                    ...
                    style={{ background: "rgba(161,0,255,0.15)", color: P.primary }}
                  >
                    {office.type}
                  </span>
                </div>
        ...
        <FadeIn>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl leading-relaxed max-w-lg mx-auto mb-10" style={{ color: P.onDarkMid }}>
