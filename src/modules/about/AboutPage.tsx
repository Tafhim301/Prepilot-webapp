...
const VALUES = [
  {
    ...
    body: "We build on open-source. Every line of code belongs to you — no vendor lock-in, no hostage fees. Walk away with everything.",
  },
  {
    icon: Zap,
    title: "Speed Without Shortcuts",
    body: "Fast delivery doesn't mean cutting corners. Our processes are tuned for both velocity and craft — because clients deserve both.",
  },
  {
    icon: Heart,
    title: "Radical Transparency",
    body: "You see every decision, every trade-off, every invoice line. Surprises belong in birthday parties, not development projects.",
  },
  {
    icon: Globe,
    title: "Global Perspective",
    body: "With teams across the US and South Asia, we bring diverse thinking to every problem — and timezone overlap that actually works.",
  },
  {
    icon: Lightbulb,
    title: "Curiosity First",
    body: "We ask why before we ask how. The best solutions come from understanding the real problem, not just executing the brief.",
  },
  {
    icon: Users,
    title: "Long-term Partnership",
    body: "We measure success in years, not sprints. Over half our revenue comes from clients we've worked with for three or more years.",
  },
];
...
const TEAM = [
  {
    ...
    role: "Founder & CEO",
    location: "Dhaka, BD",
    bio: "10 years building enterprise products. Formerly at Automattic.",
    emoji: "👨‍💻",
    color: "#8b3a2a",
  },
  {
    ...
    bio: "Ex-Figma. Obsessed with the gap between beautiful and usable.",
    emoji: "🎨",
    color: "#9b4a28",
  },
  {
    ...
    bio: "Open-source contributor. Builds things that don't break at 3am.",
    emoji: "⚙️",
    color: "#a85e26",
  },
  {
    ...
    location: "Dhaka, BD",
    bio: "Turns fuzzy briefs into clear roadmaps. MBA, ex-McKinsey.",
    emoji: "📊",
    color: "#7a3520",
  },
  {
    ...
    location: "Remote",
    bio: "Full-stack specialist. WordPress core contributor since 2018.",
    emoji: "🔧",
    color: "#6b4a2a",
  },
  {
    ...
    location: "Dhaka, BD",
    bio: "Keeps 12 clients happy simultaneously. Certified in everything.",
    emoji: "🗂️",
    color: "#8b5a30",
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-[-10%] right-[-5%] w-[700px] h-[700px] rounded-full blur-[130px] opacity-30"
          style={{ background: `radial-gradient(circle, ${P.amber}, transparent 65%)` }}
        />
        <div
          className="absolute bottom-[-15%] left-[-8%] w-[500px] h-[500px] rounded-full blur-[110px] opacity-20"
      ...
      >
        <div className="max-w-4xl">
          ...
          >
            <SectionLabel>About PrePilot</SectionLabel>
          </motion.div>
          ...
          >
            PrePilot is a full-service digital agency built for ambitious brands. We design,
          ...
          >
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold text-white transition-opacity hover:opacity-85"
              style={{ background: GRAD, boxShadow: `0 8px 24px -6px ${P.red}50` }}
            >
              Start a project <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
            </Link>
            <Link
              href="/#our-work"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold border transition-colors hover:bg-white/50"
...
function Story() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-10" style={{ background: P.darkBg }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn direction="left">
            <div
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-bold uppercase tracking-[0.18em] mb-6 border w-fit"
              style={{ background: "rgba(255,255,255,0.05)", borderColor: "rgba(255,255,255,0.12)", color: P.onDarkMid }}
            >
            ...
            <div className="space-y-5 text-base leading-relaxed" style={{ color: P.onDarkMid }}>
              <p>
                We started PrePilot in 2015 because we were tired of watching great companies
              ...
              <p>
                So we built a studio around a single principle: <strong style={{ color: P.onDark }}>
                your digital infrastructure should be yours</strong> — fully owned, fully
                understood, and fully transferable the moment you want it to be.
              </p>
              <p>
                Today we&apos;re a team of 40+ across the US and Bangladesh, having shipped 500+
                projects for brands ranging from scrappy startups to Fortune 500s. The principle
                hasn&apos;t changed.
              </p>
            </div>
          </FadeIn>
          ...
          <FadeIn direction="right" delay={0.15}>
            <div className="relative">
              ...
              >
                <svg className="w-10 h-10 mb-6 opacity-40" fill="currentColor" viewBox="0 0 32 32" style={{ color: P.amber }}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: P.onDarkMid }}>Founder & CEO, PrePilot</p>
                  </div>
                </div>
              </div>
            </div>
...
function Values() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-10" style={{ background: P.page }}>
      <div className="max-w-7xl mx-auto">
        <FadeIn className="text-center mb-16">
          ...
          <p className="mt-5 text-lg max-w-xl mx-auto leading-relaxed" style={{ color: P.inkMid }}>
            These aren&apos;t values from a branding workshop. They&apos;re the rules we&apos;ve broken enough
            times to know we shouldn&apos;t.
          </p>
        </FadeIn>
            ...
            <FadeIn key={v.title} delay={i * 0.07}>
              ...
              >
                ...
                <div
                  ...
                  style={{ background: `linear-gradient(135deg, ${P.amber}08, transparent 60%)` }}
                />
...
function Timeline() {
  return (
    <section
      className="py-24 px-4 sm:px-6 lg:px-10 overflow-hidden"
      style={{
        background: P.page,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{ background: `linear-gradient(to bottom, transparent, ${P.amber}60, transparent)` }}
          />
              ...
              return (
                <FadeIn key={item.year} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div
                      className={`flex-1 ${
                        isRight ? "lg:text-right lg:pr-12" : "lg:text-left lg:pl-12"
                      } pl-12 lg:pl-0`}
                    >
                      <motion.div
                      ...
                      >
                        ...
                        <h3 className="text-base font-bold mb-1.5" style={{ color: P.ink }}>
                          {item.title}
                        </h3>
                    ...
                    <div
                      ...
                      style={{ background: GRAD, boxShadow: `0 0 0 4px ${P.amber}30` }}
                    />
      ...
      <div className="max-w-7xl mx-auto">
        <FadeIn className="text-center mb-16">
          ...
          <p className="mt-5 text-lg max-w-xl mx-auto leading-relaxed" style={{ color: P.onDarkMid }}>
            40+ specialists across design, engineering, strategy, and delivery. Here are the
            people you&apos;ll hear from most.
          </p>
        </FadeIn>
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div
                    ...
                    style={{ background: `${member.color}25`, border: `1px solid ${member.color}30` }}
                  >
                    {member.emoji}
                  </div>
                  <span
                    className="text-[10px] font-semibold px-3 py-1 rounded-full"
                    style={{ background: "rgba(255,255,255,0.06)", color: P.onDarkMid }}
                  >
                    {member.location}
                  </span>
                </div>
                ...
                <p className="text-sm leading-relaxed" style={{ color: P.onDarkMid }}>
                  {member.bio}
                </p>
              </motion.div>
            </FadeIn>
...
function Offices() {
  const offices = [
    ...
    },
    {
      ...
      country: "Bangladesh",
      flag: "🇧🇩",
      address: "House-2/1A, Post Office Road, Mirpur-11, Dhaka-1216",
      phone: "+880 9611 656798",
  ...
  return (
    <section
      ...
      style={{ background: P.page, borderTop: `1px solid ${P.border}` }}
    >
      <div className="max-w-7xl mx-auto">
      ...
      <div className="max-w-4xl mx-auto">
        <FadeIn>
          <div
            ...
            style={{
              background: P.darkBg,
              boxShadow: `0 32px 80px -16px rgba(0,0,0,0.4), 0 8px 24px -8px ${P.red}20`,
            }}
          >
            {/* Glow */}
            <div
              ...
              style={{ background: `radial-gradient(ellipse 70% 60% at 50% 0%, ${P.red}28, transparent 55%)` }}
            />
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  href="/contact"
                  className="group inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-sm font-bold text-white transition-opacity hover:opacity-85"
                  style={{ background: GRAD, boxShadow: `0 8px 24px -6px ${P.red}60` }}
                >
                ...
                <Link
                  href="/pricing"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-sm font-bold border transition-colors"
                  style={{ borderColor: "rgba(255,255,255,0.15)", color: P.onDarkMid }}
                >
                  View pricing
                </Link>
              </div>
