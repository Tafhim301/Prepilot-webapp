          ...
          <div className="relative">
            <Avatar className="w-9 h-9">
              ...
              <AvatarFallback
                ...
                style={{ background: "rgba(160,48,200,0.2)", color: "#d090f0" }}
              >
  ...
  return (
    <div className="relative overflow-hidden py-2 group">
      ...
      <div className="absolute inset-y-0 left-0 w-28 sm:w-40 z-10 pointer-events-none"
        style={{ background: `linear-gradient(to right, ${P.pageMid}, transparent)` }} />
      <div className="absolute inset-y-0 right-0 w-28 sm:w-40 z-10 pointer-events-none"
        style={{ background: `linear-gradient(to left, ${P.pageMid}, transparent)` }} />
    </div>
  );
}
    ...
    <>
      ...
      <section className="py-16 sm:py-20 overflow-hidden relative" style={{ background: GRAD_SECTION_ALT }}>
        <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] rounded-full blur-[130px] opacity-14"
            style={{ background: `radial-gradient(ellipse, ${P.purple}, transparent 70%)` }} />
          <div className="absolute top-0 right-0 w-[350px] h-[350px] rounded-full blur-[100px] opacity-12"
            style={{ background: `radial-gradient(circle, ${P.violet}, transparent 65%)` }} />
          <div className="absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full blur-[90px] opacity-12"
