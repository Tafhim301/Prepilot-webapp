  ...
  return (
    <section className="w-full max-w-6xl px-4 sm:px-8 pb-8 pt-4">
      ...
      <div className="relative rounded-[28px] p-[1.5px]"
        style={{
          background: "linear-gradient(135deg, #8b3a2a, #9b4a28 50%, #a85e26)",
        }}
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, rgba(168,94,38,0.5), rgba(155,74,40,0.8), rgba(139,58,42,0.5), transparent)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(255,255,255,0.3) 0%, rgba(255,255,255,0.08) 50%, transparent 100%)",
            }}
          />

          {/* Left label */}
          <div className="hidden sm:flex flex-col items-center gap-0.5 flex-shrink-0 text-center select-none">
            <span className="text-[9px] font-bold uppercase tracking-[.16em] text-[#7a6e62]">
              Trusted by
            </span>
            <span
              className="text-[15px] font-extrabold leading-none"
              style={{
                background: "linear-gradient(135deg, #8b3a2a, #a85e26)",
          ...
          {/* Vertical divider */}
          <div className="hidden sm:block w-px self-stretch bg-black/10 flex-shrink-0" />

          {/* Logo grid */}
          <div className="grid grid-cols-4 md:grid-cols-8 flex-1 divide-x divide-black/[0.07]">
            {brands.map((brand) => (
              <div
                key={brand.alt}
          ...
          {/* Vertical divider */}
          <div className="hidden md:block w-px self-stretch bg-black/10 flex-shrink-0" />
          ...
          <Link
            ...
            style={{
              background:
                "linear-gradient(135deg, #8b3a2a 0%, #9b4a28 50%, #a85e26 100%)",
              boxShadow: "0 6px 20px -4px rgba(139,58,42,0.5)",
            }}
          >
