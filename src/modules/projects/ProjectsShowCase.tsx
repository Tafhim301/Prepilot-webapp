      ...
      >
        ...
        <div className="absolute top-1/2 right-8 lg:right-10 -translate-y-1/2 hover:bg-primary-gradaint rounded-full  transition-all duration-300">
          <motion.div
            ...
            className="w-14 h-14 rounded-full border-2 border-foreground/20 flex items-center justify-center group-hover:bg-foreground group-hover:border-foreground transition-colors duration-300 hover:text-white"
          >
            <ArrowRight className="w-5 h-5 text-foreground/70  transition-colors duration-300" />
          </motion.div>
        </div>
      </Link>
    </motion.div>
