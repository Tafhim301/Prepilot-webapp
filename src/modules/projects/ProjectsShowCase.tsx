...
import {
  P, GRAD, GRAD_TEXT, GRAD_SECTION_OURWORK,
          ...
          <div className="flex flex-col gap-6 pr-16">
            ...
            <div className="grid grid-cols-2 gap-6 max-w-md">
              <div>
                ...
                <p className="text-base font-semibold" style={{ color: P.ink }}>
                  {project.solution}
                </p>
              </div>
              <div>
...
export default function ProjectShowcase() {
  return (
    <section
      ...
      style={{ background: GRAD_SECTION_OURWORK }}
    >
      {/* Ambient blobs */}
      <div aria-hidden className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Primary gradient — top-right */}
        <div className="absolute -top-24 -right-24 w-[540px] h-[540px] rounded-full bg-linear-to-bl from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-18 blur-[120px]" />
        {/* Primary gradient — bottom-left */}
        <div className="absolute -bottom-20 -left-20 w-[440px] h-[440px] rounded-full bg-linear-to-tr from-[#6a00ff] via-[#a100ff] to-[#ff3c7e] opacity-14 blur-[110px]" />
        {/* Center accent */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[280px] rounded-full bg-linear-to-r from-[#6a00ff] to-[#a100ff] opacity-7 blur-[130px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-xl max-w-2xl mx-auto leading-relaxed" style={{ color: P.inkMid }}>
